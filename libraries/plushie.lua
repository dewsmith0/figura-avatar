...
local headOffset = 7 -- how high should plushie move when entity have it on helmet slot
...
function events.skull_render(delta, block, item, entity, mode)
    ...
    --         if entity ~= nil then print(entity:getType()) end
--         if entity ~= nil and (entity:getType() == "minecraft:item_display" or entity:getType() == "minecraft:block_display" or entity:getType() == "minecraft:armor_stand") then
--             return true
--         end
    end
end
